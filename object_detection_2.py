...
model = YOLO('yolo11n-pose.pt') #yolo11n.pt

# 이미지 로딩 (각자 파일 경로를 입력하세요)
image_path = './video3/frame7.jpg'
# 이미지 출력 (결과파일 경로를 입력하세요)
output_path = './video3/frame7_detected.jpg'  # Ensure the output directory exists
...
cv2.COLOR_BGR2RGBimage_rgb = cv2.cvtColor(image)
